...
我们增加了一条新的规则「prog」作为解析的入口。我们的 hi 语言将只包含一条语句「Statement」类型，就是「say_hi」。
...
我们怎么来确定语法中哪些元素应该视为词法元素还是语法元素呢？简单地说，不能再进行划分的，我可以视为词法元素，比如关键字，字符串，数值，它们在编程语言语法组成中的地位都好比我们人类语言中的单词。而编程语言中类比到人类语言中的句型的部分，规则名称需要小写，比如疑问句，陈述句之类。
